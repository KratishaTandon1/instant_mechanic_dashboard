...
const CUSTOMER_NAMES = [
  ...
  'Sai Krishna', 'Reyansh Singh', 'Aayaan Joshi', 'Ishaan Mehta', 'Krishna Rao',
...
async function main() {
  ...
  // 4. Seed 560+ Bookings
  console.log('Seeding 560+ bookings across past 12 months...');
  const now = new Date();
  ...
  console.log('✅ Seed completed successfully! 560+ Bookings, 24 Mechanics, and 60 Customers ready.');
}
